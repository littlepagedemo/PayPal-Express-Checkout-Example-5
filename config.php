...
//'------------------------------------	
$PayPalReturnURL 		= $domain.'/paypal/ecsection5/order_success.php'; //Return URL after user sign in from Paypal
...
//' This is set to the value entered on the Integration Assistant 
//'------------------------------------	
$PayPalCancelURL 		= $domain.'/paypal/ecsection5/cart.php'; // Cancel URL if user clicks cancel
